...
struct VirtualInputView: View {
    ...
    /// word). The repeat is generated by the Windows agent, at the PC's own
    /// delay and rate — Windows itself never repeats injected keys. The latched keys are pressed around it
